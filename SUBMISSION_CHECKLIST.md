...
- [x] Notebook uses the required naming style: `lisanegebriel_ethiopia_final_project.ipynb`
- [x] GitHub repository contains notebook
- [x] GitHub repository contains datasets or dataset links
- [x] README explains the project
- [x] Notebook includes markdown explanation
- [x] Notebook includes code cells
- [x] Notebook includes visualizations
- [x] Notebook includes a final conclusion
